...
used the PASTA property but did not need the
service time distribution to be exponential. Thus, we need to compute the average remaining service time $\E{S_r}$ for generally distributed service times. We turn to this task now.
